...
```bash
rm -f gsp1136.sh
curl -LO https://raw.githubusercontent.com/nov05/nov05-gcp-skills-boost/refs/heads/main/bash-scripts/gsp1136.sh
chmod +x gsp1136.sh
./gsp1136.sh
```

✅ All tasks are automated by the script. Check [the test result](https://gist.github.com/nov05/1bd42ecf192f6c2e9c7dca18adbf8151).  
